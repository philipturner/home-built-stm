...
I flattened the scary part with the other aluminum billet. The piece should be safer to handle now. Next, I'll try making multiple passes at 1000 RPM + 50 mm/min. I want to cut a 3D cuboid, composed of multiple passes in both Y and Z.
